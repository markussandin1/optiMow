// Husqvarna Automower error code → message.
// Source: Husqvarna Automower Connect API error codes (via the aioautomower
// library used by Home Assistant). Authoritative English descriptions.
export const HUSQVARNA_ERROR_CODES: Record<number, string> = {
  0: "Unexpected error",
  ...
  133: "Bluetooth communication with charging station failed",
  134: "Invalid software configuration",
  135: "Radar problem",
  ...
  156: "WiFi settings changed",
  157: "Bluetooth settings changed",
  158: "Cellular settings changed",
